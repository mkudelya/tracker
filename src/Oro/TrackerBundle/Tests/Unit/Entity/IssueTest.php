...
class IssueTest extends AbstractEntityTestCase
{
    ...
    public function getSetDataProvider()
    {
        ...
        $created = '2015-01-01';
        $updated = '2015-01-01';
        $parent = $this->getMock('Oro\TrackerBundle\Entity\Issue');
        $project = $this->getMock('Oro\TrackerBundle\Entity\Project');
        $reporter = $this->getMock('Oro\TrackerBundle\Entity\User');
        $assignee = $this->getMock('Oro\TrackerBundle\Entity\User');
    ...
    {
        $mock = $this->getMockBuilder('Oro\TrackerBundle\Entity\User')->getMock();
        $mock
    ...
    {
        $mock = $this->getMockBuilder('Oro\TrackerBundle\Entity\Comment')->getMock();
        $mock
            ->expects($this->once())
            ->method('getId')
            ->will($this->returnValue(self::TEST_ID));
