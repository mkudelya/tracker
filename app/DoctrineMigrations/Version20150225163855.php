...
class Version20150225163855 extends AbstractMigration
{
    ...
    {
        $this->addSql("INSERT INTO users (id, username, username_canonical, email, email_canonical, enabled, salt, password, last_login, locked, expired, expires_at, confirmation_token, password_requested_at, roles, credentials_expired, credentials_expire_at, fullname, avatar, timezone) VALUES (1, 'admin', 'admin', 'mkudelya@gmail.com', 'mkudelya@gmail.com', 1, 'cflqbkmyqjw4s0cw848wcgc08os0cc8', 'VUc/UVlX331u/NihZqqsfKiyNmFtSZ7i0dZDtjtR+xeRW30W2yWhLo+m7RPGPrsCuF9cVvhoOATVqlk1GWJ9YQ==', '2015-02-25 16:21:58', 0, 0, NULL, NULL, NULL, 'a:1:{i:0;s:18:\"ROLE_ADMINISTRATOR\";}', 0, NULL, 'Mike Kudelya', NULL, 'America/Los_Angeles');");
        $this->addSql("INSERT INTO users (id, username, username_canonical, email, email_canonical, enabled, salt, password, last_login, locked, expired, expires_at, confirmation_token, password_requested_at, roles, credentials_expired, credentials_expire_at, fullname, avatar, timezone) VALUES (2, 'manager', 'manager', 'manager@gmail.com', 'manager@gmail.com', 1, 'n7e5p3zi280w4coc8080go080gskgkw', 'gj6+6UczqAho7R5E7A0W89c/aLaQC1Qr5HwevBqIaI6fHP1OA0rbvOGAqwkAdE+vGCp28YJIT0NnZWrdKSxMhg==', NULL, 0, 0, NULL, NULL, NULL, 'a:1:{i:0;s:12:\"ROLE_MANAGER\";}', 0, NULL, 'Manager', NULL, 'America/Los_Angeles');");
        $this->addSql("INSERT INTO users (id, username, username_canonical, email, email_canonical, enabled, salt, password, last_login, locked, expired, expires_at, confirmation_token, password_requested_at, roles, credentials_expired, credentials_expire_at, fullname, avatar, timezone) VALUES (3, 'operator', 'operator', 'operator@gmail.com', 'operator@gmail.com', 1, 'dz6qjp7gq2o08sww4g4og40g8k8gwwo', 'gPoT+EB3cdOTmJ+DeGRRh8IMD77n6oZJWz7phCE/eyfOXnp3JHrh8xskoxUYoNpM1TKx8PZVr8kGCbI34sIRjw==', NULL, 0, 0, NULL, NULL, NULL, 'a:1:{i:0;s:13:\"ROLE_OPERATOR\";}', 0, NULL, 'Operator', NULL, 'America/Los_Angeles');");
